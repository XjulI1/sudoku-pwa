import type { GameStats, DifficultyStats } from '@/contexts/sudoku/types/sudoku'
import { Difficulty, GridSize } from '@/contexts/sudoku/types/sudoku'
import { SudokuScoreCalculator } from './sudokuScoreCalculator'
 ...
 */
export class SudokuStatsManager {
  /**
  ...
  static saveGameStats(
    ...
    const score = SudokuScoreCalculator.calculateScore(
      difficulty,
      errorsCount,
      hintsUsed,
      completionTime,
