...
import type { TectonicGrid, RegionGrid, Position } from '@/contexts/tectonic/types/tectonic'
...
import { TectonicValidator } from '@/contexts/tectonic/utils/tectonicValidator'
